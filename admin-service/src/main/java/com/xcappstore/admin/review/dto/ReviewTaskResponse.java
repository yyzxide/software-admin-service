...
public class ReviewTaskResponse {
    ...
    private List<ReviewHistoryResponse> histories = new ArrayList<>();
    ...
    public List<ReviewHistoryResponse> getHistories() { return histories; }
    public void setHistories(List<ReviewHistoryResponse> histories) { this.histories = histories; }
}
